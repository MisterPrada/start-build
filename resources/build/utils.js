...
module.exports.themeRootPath = (basePath = "", destPath = "") =>
	slash(path.resolve(__dirname, "../", basePath, destPath));
...
module.exports.blockPath = (basePath = "", destPath = "") =>
	path.resolve(__dirname, "../../blocks", basePath, destPath);
...
module.exports.buildStylesBlocksPath = (destPath) =>
	exports.buildPath("css/blocks", destPath);
